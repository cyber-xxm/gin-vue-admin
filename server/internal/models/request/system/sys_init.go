...
// ToMysqlConfig 转换 orm.Mysql
// Author [SliverHorn](https://github.com/SliverHorn)
func (i *InitDB) ToMysqlConfig() orm.Mysql {
	return orm.Mysql{
		GeneralDB: orm.GeneralDB{
			Path:         i.Host,
			Port:         i.Port,
			Dbname:       i.DBName,
			Username:     i.UserName,
...
// ToPgsqlConfig 转换 orm.Pgsql
// Author [SliverHorn](https://github.com/SliverHorn)
func (i *InitDB) ToPgsqlConfig() orm.Pgsql {
	return orm.Pgsql{
		GeneralDB: orm.GeneralDB{
			Path:         i.Host,
			Port:         i.Port,
...
// ToSqliteConfig 转换 orm.Sqlite
// Author [Kafumio](https://github.com/Kafumio)
func (i *InitDB) ToSqliteConfig() orm.Sqlite {
	return orm.Sqlite{
		GeneralDB: orm.GeneralDB{
			Path:         i.DBPath,
			Port:         i.Port,
...
func (i *InitDB) ToMssqlConfig() orm.Mssql {
	return orm.Mssql{
		GeneralDB: orm.GeneralDB{
			Path:         i.DBPath,
			Port:         i.Port,
