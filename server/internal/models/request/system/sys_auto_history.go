...
func (r *SysAutoHistoryCreate) Create() system.SysAutoCodeHistory {
	entity := system.SysAutoCodeHistory{
		Package:          r.Package,
		Request:          r.Request,
		Table:            r.Table,
...
func (r *SysAutoHistoryRollBack) ApiIds(entity system.SysAutoCodeHistory) request.IdsReq {
