	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				...
				ImportPath:      `"github.com/cyber-xxm/gin-vue-admin/internal/utils/plugin/gva/service"`,
				StructName:      "User",
		...
		},
		{
			...
			fields: fields{
				...
				ImportPath:      `"github.com/cyber-xxm/gin-vue-admin/internal/utils/plugin/gva/api"`,
				StructName:      "User",
				StructCamelName: "user",
				ModuleName:      "userApi",
				GroupName:       "Api",
