	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				...
				ImportPath:        `"github.com/cyber-xxm/gin-vue-admin/api/v1/example"`,
		...
		},
		{
			...
			fields: fields{
				...
				ImportPath:        `"github.com/cyber-xxm/gin-vue-admin/router/example"`,
				StructName:        "Example",
				PackageName:       "example",
		...
		},
		{
			...
			fields: fields{
				...
				ImportPath:        `"github.com/cyber-xxm/gin-vue-admin/service/example"`,
