...
func (*Local) UploadFile(file *multipart.FileHeader) (string, string, error) {
	...
	if mkdirErr != nil {
		zap_logger.Error("function os.MkdirAll() failed", zap.Any("err", mkdirErr.Error()))
	...
	if createErr != nil {
		zap_logger.Error("function os.Create() failed", zap.Any("err", createErr.Error()))
	...
	if copyErr != nil {
		zap_logger.Error("function io.Copy() failed", zap.Any("err", copyErr.Error()))
