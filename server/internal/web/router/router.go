...
import (
	...
	"github.com/cyber-xxm/gin-vue-admin/internal/utils/plugin/email/router"
...
func Routers(ctx context.Context) *gin.Engine {
	Router := gin.New()
	...
	//插件路由安装
	plugin.InstallPlugin(PrivateGroup, PublicGroup, Router)
