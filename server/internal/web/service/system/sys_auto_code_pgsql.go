...
func NewAutoCodePgsqlService(db *gorm.DB) *AutoCodePgsqlService {
	return &AutoCodePgsqlService{
		db: db,
	}
}

type AutoCodePgsqlService struct {
	db *gorm.DB
}
...
func (s *AutoCodePgsqlService) GetDB(businessDB string) (data []sysResp.Db, err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
// Author [SliverHorn](https://github.com/SliverHorn)
func (s *AutoCodePgsqlService) GetTables(businessDB string, dbName string) (data []sysResp.Table, err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
// Author [SliverHorn](https://github.com/SliverHorn)
func (s *AutoCodePgsqlService) GetColumn(businessDB string, tableName string, dbName string) (data []sysResp.Column, err error) {
	// todo 数据获取不全, 待完善sql
	sql := `
SELECT
