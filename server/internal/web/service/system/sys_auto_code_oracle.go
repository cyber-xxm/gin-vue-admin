...
func NewAutoCodeOracleService(db *gorm.DB) *AutoCodeOracleService {
	return &AutoCodeOracleService{
		db: db,
	}
}

type AutoCodeOracleService struct {
	db *gorm.DB
}
...
func (s *AutoCodeOracleService) GetDB(businessDB string) (data []sysResp.Db, err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
// Author [SliverHorn](https://github.com/SliverHorn)
func (s *AutoCodeOracleService) GetTables(businessDB string, dbName string) (data []sysResp.Table, err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
// Author [SliverHorn](https://github.com/SliverHorn)
func (s *AutoCodeOracleService) GetColumn(businessDB string, tableName string, dbName string) (data []sysResp.Column, err error) {
