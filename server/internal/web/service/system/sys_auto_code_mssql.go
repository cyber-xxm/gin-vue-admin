...
func NewAutoCodeMssqlService(db *gorm.DB) *AutoCodeMssqlService {
	return &AutoCodeMssqlService{
		db: db,
	}
}

type AutoCodeMssqlService struct {
	db *gorm.DB
}
...
func (s *AutoCodeMssqlService) GetDB(businessDB string) (data []sysResp.Db, err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
// Author [SliverHorn](https://github.com/SliverHorn)
func (s *AutoCodeMssqlService) GetTables(businessDB string, dbName string) (data []sysResp.Table, err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
// Author [SliverHorn](https://github.com/SliverHorn)
func (s *AutoCodeMssqlService) GetColumn(businessDB string, tableName string, dbName string) (data []sysResp.Column, err error) {
