...
// TokenNext 登录以后签发jwt
func (a *BaseApi) TokenNext(c *gin.Context, user system.SysUser) {
	token, claims, err := utils.LoginToken(&user)
	if err != nil {
		zap_logger.Error("获取token失败!", zap.Error(err))
...
func (a *BaseApi) ChangePassword(c *gin.Context) {
	var req system2.ChangePasswordReq
...
func (a *BaseApi) GetUserList(c *gin.Context) {
	var pageInfo system2.GetUserList
...
func (a *BaseApi) SetUserAuthority(c *gin.Context) {
	var sua system2.SetUserAuth
...
func (a *BaseApi) SetUserAuthorities(c *gin.Context) {
	var sua system2.SetUserAuthorities
	err := c.ShouldBindJSON(&sua)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
...
func (a *BaseApi) DeleteUser(c *gin.Context) {
...
func (a *BaseApi) SetUserInfo(c *gin.Context) {
	var user system2.ChangeUserInfo
...
func (a *BaseApi) SetSelfInfo(c *gin.Context) {
	var user system2.ChangeUserInfo
	err := c.ShouldBindJSON(&user)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
...
func (a *BaseApi) SetSelfSetting(c *gin.Context) {
	var req models.JSONMap
	err := c.ShouldBindJSON(&req)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
...
func (a *BaseApi) ResetPassword(c *gin.Context) {
