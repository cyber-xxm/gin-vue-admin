...
func NewSystemApi(db *gorm.DB) *SystemApi {
	return &SystemApi{
		SystemApiService: service.NewApiService(db),
	}
}

type SystemApi struct {
	SystemApiService *service.ApiService
}
...
func (a *SystemApi) CreateApi(c *gin.Context) {
	...
	err = a.SystemApiService.CreateApi(api)
	if err != nil {
...
func (a *SystemApi) SyncApi(c *gin.Context) {
	newApis, deleteApis, ignoreApis, err := a.SystemApiService.SyncApi()
	if err != nil {
...
func (a *SystemApi) GetApiGroups(c *gin.Context) {
	groups, apiGroupMap, err := a.SystemApiService.GetApiGroups()
	if err != nil {
...
func (a *SystemApi) IgnoreApi(c *gin.Context) {
	...
	err = a.SystemApiService.IgnoreApi(ignoreApi)
	if err != nil {
...
func (a *SystemApi) EnterSyncApi(c *gin.Context) {
	...
	err = a.SystemApiService.EnterSyncApi(syncApi)
	if err != nil {
		zap_logger.Error("忽略失败!", zap.Error(err))
		response.FailWithMessage("忽略失败", c)
		return
...
func (a *SystemApi) DeleteApi(c *gin.Context) {
	var api system.SysApi
	err := c.ShouldBindJSON(&api)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
	...
	err = a.SystemApiService.DeleteApi(api)
	if err != nil {
...
func (a *SystemApi) GetApiList(c *gin.Context) {
	...
	list, total, err := a.SystemApiService.GetAPIInfoList(pageInfo.SysApi, pageInfo.PageInfo, pageInfo.OrderKey, pageInfo.Desc)
	if err != nil {
		zap_logger.Error("获取失败!", zap.Error(err))
		response.FailWithMessage("获取失败", c)
		return
...
func (a *SystemApi) GetApiById(c *gin.Context) {
	...
	api, err := a.SystemApiService.GetApiById(idInfo.ID)
	if err != nil {
		zap_logger.Error("获取失败!", zap.Error(err))
		response.FailWithMessage("获取失败", c)
		return
...
func (a *SystemApi) UpdateApi(c *gin.Context) {
	var api system.SysApi
	err := c.ShouldBindJSON(&api)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
	...
	err = a.SystemApiService.UpdateApi(api)
	if err != nil {
...
func (a *SystemApi) GetAllApis(c *gin.Context) {
	authorityID := utils.GetUserAuthorityId(c)
	apis, err := a.SystemApiService.GetAllApis(authorityID)
	if err != nil {
		zap_logger.Error("获取失败!", zap.Error(err))
		response.FailWithMessage("获取失败", c)
		return
...
func (a *SystemApi) DeleteApisByIds(c *gin.Context) {
	...
	err = a.SystemApiService.DeleteApisByIds(ids)
	if err != nil {
		zap_logger.Error("删除失败!", zap.Error(err))
		response.FailWithMessage("删除失败", c)
		return
...
func (a *SystemApi) FreshCasbin(c *gin.Context) {
