...
func OperationRecord(operationRecordService *service.OperationRecordService) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if c.Request.Method != http.MethodGet {
			...
			if err != nil {
				zap_logger.Error("read body from request error:", zap.Error(err))
			} else {
		...
		if err := operationRecordService.CreateSysOperationRecord(record); err != nil {
			zap_logger.Error("create operation record error:", zap.Error(err))
		}
	}
}
