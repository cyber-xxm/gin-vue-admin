...
import (
	...
	"github.com/cyber-xxm/gin-vue-admin/internal/utils/plugin"
	"github.com/cyber-xxm/gin-vue-admin/internal/utils/plugin/email"
...
func bizPluginV1(group ...*gin.RouterGroup) {
	...
	initialize.holder(public, private)
}
